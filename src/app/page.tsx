...
export default function Home() {
  ...
  return (
    <main className="overflow-x-hidden">
      ...
      <section className="py-32 bg-gradient-to-br from-brand03/20 via-neutral01 to-brand01/60 relative overflow-hidden">
      ...
      <section className="py-32 bg-gradient-to-bl from-brand01/60 via-neutral01 to-teal-50 relative overflow-hidden border-t border-brand01/20">
        {/* Background patterns */}
      ...
      <section className="pt-0 border-b border-brand01">
      ...
      <section className="relative py-32 overflow-hidden">
        {/* Animated background */}
        <div className="absolute inset-0 bg-gradient-to-br from-brand01/60 via-neutral01 to-neutral01"></div>
